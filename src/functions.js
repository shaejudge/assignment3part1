...
//your code here
bar = function anonymous(doubleArray) 
...
function parseGit(logArray) {
	var hash = text.slice(0, 7);
	var date = text.slice(8, 38);
	var message= text.slice(39, 55);
	var space = " ";
	var fullArray = hash.concat(space,date,space,message);
	return fullArray;
}
